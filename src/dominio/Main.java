...
public class Main {
	...
	static Localidade l5 = new Localidade("t05", "Amapá");
	static Localidade l6 = new Localidade("t06", "Ubiratã");
	
	static Localidade l7 = new Localidade("t07", "Maceió");
	...
	static Fracionadas f2 = new Fracionadas("e301", d3);
	...
	public static void main(String[] args) {
		...
		System.out.println(f1.verificaRotas("Rondônia", "Maranhão"));
		
		System.out.println(f1.mostrarRotas("Rondônia", "Maranhão"));
